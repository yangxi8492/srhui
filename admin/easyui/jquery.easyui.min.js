...
(function($) {
    ...
    $.messager = {
        ...
        alert: function(_285, msg, icon, fn) {
            var _286 = "<div class=alertip>" + msg + "</div>";
            switch (icon) {
            case "error":
        ...
        confirm: function(_288, msg, fn) {
            var _289 = "<div class=\"messager-icon messager-question\"></div>" + "<p class=tipcons>" + msg + "</p>" + "<div style=\"clear:both;\"/>";
            var _28a = {};
        ...
        prompt: function(_28b, msg, fn) {
            var _28c = "<div class=\"messager-icon messager-question\"></div>" + "<p class=tipcons>" + msg + "</p>" + "<br/>" + "<div style=\"clear:both;\"/>" + "<div><input class=\"messager-input\" type=\"text\"/></div>";
            var _28d = {};
    ...
    $.fn.combo.defaults, {
        ...
        {
            text: function(_10945) {
                return $(_10945).datebox("options").cleanText;
            },
            handler: function(_10946) {
                $(_10946).combo('setValue', '').combo('setText', '');  
