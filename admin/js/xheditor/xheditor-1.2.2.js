    ...
    Xheditor = function(textarea, options) {
        ...
        this.uploadInit = function(a, b, c) {
            ...
            if (a.after(e), f.before(a), b = b.replace(/{editorRoot}/gi, editorRoot), "!" === b.substr(0, 1)) f.click(function() {
                ...
                e.append('<input type="file"' + (h > 1 ? ' multiple=""': "") + ' class="xheFile" size="13" name="' + uploadInputname + '" tabindex="-1" accept="image/*" /><input type="hidden" value="8" name="objectTable">');
                var i, j = $(".xheFile", e);
                j.change(function() {
                    i = [],
        ...
        this.html4Upload = function(a, b, c) {
            ...
            h = $('<form action="' + b + '" target="' + e + '" method="post" enctype="multipart/form-data" class="xheHideArea"><input type="hidden" value="8" name="objectTable"></form>').appendTo("body"),
            i = $(a),
